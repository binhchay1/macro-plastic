                            ...
                            foreach ( $recent_posts as $value ) {
                                $post_loop .= '<div class="wopb-block-item">';
                                    $post_loop .= '<div class="wopb-block-content-wrap">';
                                        if( $attr['showImage'] ){
                                            if( $value['image'] ) {
                                            $post_loop .= '<div class="wopb-block-image wopb-block-image-'.sanitize_html_class($attr['imgAnimation']).'"><a href="'.esc_url($value['url']).'" class="wopb-product-cat-img"><img src='.esc_url($value['image'][$image_size]).' alt='.esc_attr($value['name']).'/></a></div>';
                                            } else {
