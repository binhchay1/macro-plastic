...
class VariationSwatches
{
    ...
    public function add_variation_swatches_scripts()
    {
        ...
        $image_width = wopb_function()->get_setting('variation_image_width');
        $image_height = wopb_function()->get_setting('variation_image_height');
        $width = wopb_function()->get_setting('variation_switch_width');
        $height = wopb_function()->get_setting('variation_switch_height');
...
?>
        <style>
            ...
            .wopb-swatch img {
                width: <?php echo esc_attr( $image_width ) ?>px !important;
...
<?php
    ...
    {
        $column_head = esc_html($this->attribute_types[self::COLOR], 'product-blocks');
    ...
    {
        $column_head = esc_html($this->attribute_types[self::IMAGE], 'product-blocks');
        return $this->create_attribute_column($columns, $column_head);
    }
    ...
    {
        $column_head = esc_html($this->attribute_types[self::LABEL], 'product-blocks');
        return $this->create_attribute_column($columns, $column_head);
    }
