...
Plugin URI: 
Description: A plugin including function, shortcode and some widget to use with Totalbusiness Theme ( This plugin functionality might not working properly on another theme )
Version: 1.0.1
Author: Goodlayers
	...
	function gdlr_init_page_feature() {
		...
		register_taxonomy(
			'page_category', array("page"), array(
				'hierarchical' => true,
				'label' => __('Page Categories', 'totalbusiness'), 
				'singular_label' => __('Page Category', 'totalbusiness'), 
...
add_filter('totalbusiness_the_content', 'gdlr_fix_shortcodes', 9);
add_filter('totalbusiness_the_content', 'gdlr_fix_shortcodes_callback', 11);
