...
add_action( 'tgmpa_register', 'totalbusiness_register_required_plugins' );
if( !function_exists('totalbusiness_register_required_plugins') ){
	function totalbusiness_register_required_plugins(){
		$plugins = array(
			array(
				'name'     				=> 'masterslider',
				'slug'     				=> 'masterslider', 
		...
		$config = array(
			'id'           => 'totalbusiness',                 // Unique ID for hashing notices for multiple instances of TGMPA.
