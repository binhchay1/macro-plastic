...
add_action( 'widgets_init', 'totalbusiness_recent_portfolio_widget' );
if( !function_exists('totalbusiness_recent_portfolio_widget') ){
	function totalbusiness_recent_portfolio_widget() {
	...
	class Goodlayers_Recent_Portfolio extends WP_Widget{
		...
		function __construct() {
			parent::__construct(
				...
				esc_html__('Goodlayers Recent Portfolio Widget','totalbusiness'), 
				array('description' => esc_html__('A widget that show lastest portfolios', 'totalbusiness')));  
		}
		...
		function widget( $args, $instance ) {
			...
			if($query->have_posts()){
				echo '<div class="totalbusiness-recent-port-widget">';
				while($query->have_posts()){ $query->the_post();
					...
					echo '<div class="blog-info blog-date totalbusiness-skin-info">';
					echo get_the_time($theme_option['date-format']);
					echo '</div>';
					echo '</div>';
					echo '</div>';
