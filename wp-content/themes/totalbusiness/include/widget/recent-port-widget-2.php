...
add_action( 'widgets_init', 'totalbusiness_recent_portfolio2_widget' );
if( !function_exists('totalbusiness_recent_portfolio2_widget') ){
	function totalbusiness_recent_portfolio2_widget() {
	...
	class Goodlayers_Recent_Portfolio2 extends WP_Widget{
		...
		function __construct() {
			parent::__construct(
				...
				esc_html__('Goodlayers Recent Portfolio 2 Widget','totalbusiness'), 
				array('description' => esc_html__('A widget that show lastest portfolios in 2nd style', 'totalbusiness')));  
		}
		...
		function widget( $args, $instance ) {
			...
			if($query->have_posts()){
				echo '<div class="totalbusiness-recent-port2-widget">';
