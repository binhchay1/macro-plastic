(function($){
	...
	function gdlrCreateTabItem( options ){
		...
		tab_item.find('.totalbusiness-upload-wrapper .gdl-text-input').each(function(){
			if( $(this).val() ){
			...
			$(this).change(function(){
				...
				if( $(this).val() == '' ){ 
					$(this).siblings('.totalbusiness-upload-img-sample').addClass('blank').trigger('change'); 
				}else{
					$(this).siblings('.totalbusiness-upload-img-sample').attr('src', $(this).val()).removeClass('blank').trigger('change');
				}
			});
		});
		tab_item.find('.totalbusiness-upload-box-button').click(function(){
			...
			var custom_uploader = wp.media({
				...
				upload_button.siblings('.totalbusiness-upload-box-hidden').val(attachment.id).trigger('change');
			}).open();			
		});		
		...
		$(this).gdlrAddMoreTabs({
			default_item	: 	'<div class="edit-box-input-wrapper">\
								...
								<div class="edit-box-input-wrapper">\
									...
									<div class="totalbusiness-combobox-wrapper">\
			...
			textarea		: 	$('<textarea class="totalbusiness-input-hidden" name="' + option.attr('data-name') + '">' + value + '</textarea>')
		});
	}
	...
	$.fn.gdlrEditBoxTab = function( option ){	
		...
		$(this).gdlrAddMoreTabs({
			...
			default_title	: 	option.attr('data-default-title'),
			textarea		: 	$('<textarea class="totalbusiness-input-hidden" name="' + option.attr('data-name') + '">' + totalbusiness_esc_attr(value) + '</textarea>')
		});
	}
	...
	$.fn.gdlrEditBoxIconWithList = function( option ){	
		...
		$(this).gdlrAddMoreTabs({
			default_item	: 	'<div class="edit-box-input-wrapper">\
									...
									<div class="totalbusiness-upload-wrapper">\
										<img class="totalbusiness-upload-img-sample blank" src="">\
										<div class="clear"></div>\
										<input type="text" class="gdl-text-input" data-name="gdl-tab-image-url" >\
										<input type="text" class="totalbusiness-upload-box-hidden" data-name="gdl-tab-image">\
										<input type="button" class="totalbusiness-upload-box-button gdl-button" value="Upload"></div>\
										<div class="clear"></div>\
									</div>\
								</div>\
								<div class="edit-box-input-wrapper">\
	...
	$.fn.gdlrEditBoxAuthor = function( option ){	
		...
		var default_input = '<div class="edit-box-input-wrapper">\
								...
								<div class="totalbusiness-upload-wrapper">\
									...
									<input type="text" class="totalbusiness-upload-box-hidden" data-name="gdl-tab-author-image">\
									<input type="button" class="totalbusiness-upload-box-button gdl-button" value="Upload"></div>\
									<div class="clear"></div>\
								</div>\
							</div>\
			...
			case 'upload':
				return 	'<div class="edit-box-input-wrapper">\
							...
							<div class="totalbusiness-upload-wrapper">\
								...
								<div class="clear"></div>\
								<input type="text" class="gdl-text-input" data-name="gdl-tab-author-image-url" >\
								<input type="text" class="totalbusiness-upload-box-hidden" data-name="' + slug + '">\
								<input type="button" class="totalbusiness-upload-box-button gdl-button" value="Upload"></div>\
								<div class="clear"></div>\
							</div>\
						</div>';
