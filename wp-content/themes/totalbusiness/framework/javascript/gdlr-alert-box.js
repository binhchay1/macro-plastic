(function($){
	...
	$.fn.totalbusiness_alert = function(options){
		...
		$(this).each(function(){
			...
			var alert_box = $('<div class="totalbusiness-alert-wrapper"></div>');
	...
	// create the alert message
	$.fn.totalbusiness_confirm = function(options){
		...
		$(this).each(function(){
			...
			var confirm_button = $('<span class="totalbusiness-button confirm-yes">Yes</span>');
			var decline_button = $('<span class="totalbusiness-button confirm-no">No</span>');
		
			var confirm_box = $('<div class="totalbusiness-confirm-wrapper"></div>');
