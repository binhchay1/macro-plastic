(function($){
	...
	$(document).ready(function(){
		...
		$('#wpbody-content').on('click', '.editor-post-publish-button, .editor-post-preview', function(){
			...
			var page_option = $('.totalbusiness-page-option-wrapper');
			...
			page_option.each(function(){
				...
				$(this).children('textarea.totalbusiness-input-hidden').val(JSON.stringify(page_option));
			});
		...
		$('#totalbusiness-load-demo-wrapper').each(function(){
			...
			$(this).children('input[type="button"]').click(function(){
				...
				$('body').totalbusiness_confirm({ success: function(){
					$.ajax({
						type: 'POST',
						url: ajax_url,
