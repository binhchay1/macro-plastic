<?php
	...
	*/
	...
	if( !class_exists('totalbusiness_tax_meta') ){
		class totalbusiness_tax_meta{
			...
			function __construct($setting = array(), $option = array()){
				...
				$default_setting = array( 
					'taxonomy' => 'category',
					'slug' => 'totalbusiness_category_meta'
				);
			...
			function include_script( $page ){
				if( $page == 'edit-tags.php' || $page == 'term.php' ){
					...
					wp_enqueue_style('totalbusiness-tax-meta', get_template_directory_uri() . '/framework/stylesheet/gdlr-tax-meta.css');	
					...
					wp_enqueue_script('totalbusiness-tax-meta', get_template_directory_uri() . '/framework/javascript/gdlr-tax-meta.js', array('jquery'));
				}
			}
				...
				if ( isset($_POST['term_meta']) ){
					...
					foreach( $cat_keys as $key ){
						if ( isset($_POST['term_meta'][$key]) ) {
							$term_meta[$term->slug][$key] = totalbusiness_stripslashes($_POST['term_meta'][$key]);
						}
					}
			...
			function textarea_box( $option ){
				echo '<textarea type="text" class="totalbusiness-textarea" name="term_meta[' . $option['slug'] . ']" ';
			...
			function date_picker( $option ){
				echo '<input class="totalbusiness-date-picker" type="text" name="term_meta[' . $option['slug'] . ']" ';
				echo 'id="term_meta[' . $option['slug'] . ']" ';
				echo 'value="' . $option['value'] . '">';
			}			
			...
			function upload_media_box( $option ){
				echo '<img class="totalbusiness-preview" ';
				...
				echo '<input type="text" class="totalbusiness-half totalbusiness-upload-box-input" ';
				echo 'id="term_meta[' . $option['slug'] . ']" ';
				...
				echo '<input type="button" class="totalbusiness-upload-media" value="' . esc_html__('Upload', 'totalbusiness') . '" >';
